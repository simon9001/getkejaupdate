...
function resolveStatus(err: Error): 400 | 403 | 404 | 422 | 500 {
  ...
  if (msg.includes('forbidden') || msg.includes('not owner')) return 403;
...
export class LandlordController {
  ...
  async createProperty(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'PROPERTY_CREATE_FAILED'); }
  }
  ...
  async updateProperty(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'PROPERTY_UPDATE_FAILED'); }
  }
  ...
  async deleteProperty(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'PROPERTY_DELETE_FAILED'); }
  }
   ...
   * Body: { "status": "let" }
   */
  async updatePropertyStatus(c: Context) {
    try {
      const userId = c.get('user').userId;
      const propertyId = c.req.param('id');
    ...
    } catch (err) { return fail(c, err, 'STATUS_UPDATE_FAILED'); }
  }
  ...
  async addMedia(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'MEDIA_ADD_FAILED'); }
  }
  ...
  async deleteMedia(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'MEDIA_DELETE_FAILED'); }
  }
  ...
  async setCoverPhoto(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'COVER_SET_FAILED'); }
  }
  ...
  async listTenancies(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'TENANCIES_FETCH_FAILED'); }
  }
  ...
  async getTenancy(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'TENANCY_FETCH_FAILED'); }
  }
   ...
   */
  async approveTenancy(c: Context) {
    try {
      const userId = c.get('user').userId;
      const tenancyId = c.req.param('id');
      const body = await c.req.json();
    ...
    } catch (err) { return fail(c, err, 'TENANCY_APPROVE_FAILED'); }
  }
  ...
  async rejectTenancy(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'TENANCY_REJECT_FAILED'); }
  }
   ...
   */
  async terminateTenancy(c: Context) {
    try {
      const userId = c.get('user').userId;
      const tenancyId = c.req.param('id');
      const body = await c.req.json();
    ...
    } catch (err) { return fail(c, err, 'TENANCY_TERMINATE_FAILED'); }
  }
   ...
   */
  async getShortStayBooking(c: Context) {
    try {
      const userId = c.get('user').userId;
    ...
    } catch (err) { return fail(c, err, 'SS_BOOKING_FETCH_FAILED'); }
  }
   ...
   */
  async updateShortStayBookingStatus(c: Context) {
    try {
      const userId = c.get('user').userId;
      const bookingId = c.req.param('id');
      const { status } = await c.req.json();
    ...
    } catch (err) { return fail(c, err, 'SS_BOOKING_STATUS_UPDATE_FAILED'); }
  }
  ...
  async listVisits(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'VISITS_FETCH_FAILED'); }
  }
  ...
  async confirmVisit(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'VISIT_CONFIRM_FAILED'); }
  }
   ...
   */
  async rescheduleVisit(c: Context) {
    try {
      const userId = c.get('user').userId;
      const visitId = c.req.param('id');
    ...
    } catch (err) { return fail(c, err, 'VISIT_RESCHEDULE_FAILED'); }
  }
  ...
  async cancelVisit(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'VISIT_CANCEL_FAILED'); }
  }
  ...
  async listConversations(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'CONVERSATIONS_FETCH_FAILED'); }
  }
  ...
  async getMessages(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'MESSAGES_FETCH_FAILED'); }
  }
  ...
  async sendMessage(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'MESSAGE_SEND_FAILED'); }
  }
   ...
   */
  async markConversationRead(c: Context) {
    try {
      const userId = c.get('user').userId;
      const conversationId = c.req.param('id');
    ...
    } catch (err) { return fail(c, err, 'CONVERSATION_READ_FAILED'); }
  }
   ...
   */
  async removeTeamMember(c: Context) {
    try {
      const userId = c.get('user').userId;
    ...
    } catch (err) { return fail(c, err, 'TEAM_MEMBER_REMOVE_FAILED'); }
  }
   ...
   */
  async getPayoutTransactions(c: Context) {
    try {
      const userId = c.get('user').userId;
      const page = Number(c.req.query('page')) || 1;
      const limit = Math.min(100, Number(c.req.query('limit')) || 20);
    ...
    } catch (err) { return fail(c, err, 'PAYOUTS_FETCH_FAILED'); }
  }
  ...
  async getSubscription(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'SUBSCRIPTION_FETCH_FAILED'); }
  }
  ...
  async cancelSubscription(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'SUBSCRIPTION_CANCEL_FAILED'); }
  }
   ...
   */
  async getPropertyReviews(c: Context) {
    try {
      const userId = c.get('user').userId;
      const page = Number(c.req.query('page')) || 1;
      const limit = Math.min(100, Number(c.req.query('limit')) || 20);
  ...
  async replyToReview(c: Context) {
    ...
    } catch (err) { return fail(c, err, 'REVIEW_REPLY_FAILED'); }
  }
