...
export class SubscriptionsService {
   ...
   */
  async subscribeWithPaystack(
    userId: string,
    input: { plan_id: string; billing_cycle: 'monthly' | 'annual'; paystack_reference: string },
  ) {
    ...
    logger.info(
      { userId, planId: plan_id, billing_cycle, reference: paystack_reference },
      'subscription.paystack.created',
    );
    return data;
  }
