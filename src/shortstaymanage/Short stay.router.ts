...
shortStayRouter.get(
  ...
  (c) => shortStayController.checkAvailability(c),
);
...
shortStayRouter.get(
  '/calendar/:propertyId',
  (c) => shortStayController.getCalendar(c),
);
...
shortStayRouter.get(
  '/quote/:propertyId',
  (c) => shortStayController.getPriceQuote(c),
);
...
shortStayRouter.get(
  '/reviews/:propertyId',
  (c) => shortStayController.getPropertyReviews(c),
);
...
shortStayRouter.get(
  '/bookings/my/guest',
  authenticate,
  (c) => shortStayController.getMyGuestBookings(c),
);

shortStayRouter.get(
  '/bookings/my/host',
  authenticate,
  (c) => shortStayController.getMyHostBookings(c),
);
 ...
 */
shortStayRouter.post(
  '/bookings',
  authenticate,
  zValidator('json', createBookingSchema),
  (c) => shortStayController.createBooking(c),
);

shortStayRouter.get(
  '/bookings/:id',
  authenticate,
  (c) => shortStayController.getBooking(c),
);
...
shortStayRouter.post(
  ...
  (c) => shortStayController.cancelBooking(c),
);
...
shortStayRouter.post(
  ...
  (c) => shortStayController.recordCheckin(c),
);
...
shortStayRouter.post(
  ...
  authenticate,
  (c) => shortStayController.confirmCheckin(c),
);
...
shortStayRouter.post(
  '/reviews/property',
  authenticate,
  zValidator('json', submitPropertyReviewSchema),
  (c) => shortStayController.submitPropertyReview(c),
);
...
shortStayRouter.post(
  '/reviews/guest',
  authenticate,
  zValidator('json', submitGuestReviewSchema),
  (c) => shortStayController.submitGuestReview(c),
);
...
shortStayRouter.post(
  ...
  authenticate,
  (c) => shortStayController.replyToReview(c),
);
...
shortStayRouter.post(
  '/disputes',
  authenticate,
  zValidator('json', raiseDisputeSchema),
  (c) => shortStayController.raiseDispute(c),
);
...
shortStayRouter.get(
  ...
  authenticate,
  requireAdmin,
  (c) => shortStayController.getAllBookingsAdmin(c),
);
...
shortStayRouter.get(
  ...
  authenticate,
  requireAdmin,
  (c) => shortStayController.getOpenDisputes(c),
);
 ...
 */
shortStayRouter.patch(
  '/admin/disputes/:id/resolve',
  authenticate,
  requireAdmin,
  zValidator('json', resolveDisputeSchema),
  (c) => shortStayController.resolveDispute(c),
);
...
shortStayRouter.patch(
  ...
  authenticate,
  requireAdmin,
  (c) => shortStayController.flagReview(c),
);

/** DELETE /api/short-stay/admin/reviews/:id */
shortStayRouter.delete(
  '/admin/reviews/:id',
  authenticate,
  requireAdmin,
  (c) => shortStayController.removeReview(c),
);
