...
propertiesRouter.get(
    ...
    (c) => propertiesController.getUnverifiedProperties(c)
);
...
propertiesRouter.get(
    ...
    authenticate,
    requireRoles('admin'),
    (c) => propertiesController.getAllProperties(c)
);
...
propertiesRouter.get(
    ...
    authenticate,
    requireRoles('admin'),
    (c) => propertiesController.getCategoryStatistics(c)
);
...
propertiesRouter.post(
    '/',
    authenticate,
    requireRoles('landlord', 'agent', 'caretaker'),
...
propertiesRouter.post(
    '/:id/images',
    authenticate,
    (c) => propertiesController.addPropertyImages(c)
);

propertiesRouter.delete(
    '/images/:imageId',
    authenticate,
    (c) => propertiesController.deletePropertyImage(c)
);
...
propertiesRouter.patch(
    ...
    authenticate,
    requireRoles('admin', 'verifier'),
    (c) => propertiesController.verifyProperty(c)
);
...
propertiesRouter.patch(
    ...
    authenticate,
    requireRoles('admin', 'verifier'),
    (c) => propertiesController.rejectProperty(c)
);
...
propertiesRouter.patch(
    ...
    authenticate,
    requireRoles('admin'),
    (c) => propertiesController.boostProperty(c)
);
...
propertiesRouter.patch(
    ...
    authenticate,
    requireRoles('admin'),
    (c) => propertiesController.strikeProperty(c)
);
