...
authRouter.post(
  '/register',
  rateLimit({ windowMs: WINDOW_15M, max: 5, limitByEmail: true }),
...
authRouter.post(
  '/login',
  rateLimit({ windowMs: WINDOW_15M, max: 10 }),
...
authRouter.post(
  '/resend-verification',
  rateLimit({ windowMs: WINDOW_10M, max: 3, limitByEmail: true }),
...
authRouter.post(
  '/refresh-token',
  rateLimit({ windowMs: WINDOW_15M, max: 20 }),
...
authRouter.post(
  '/reset-password',
  rateLimit({ windowMs: WINDOW_15M, max: 5 }),
