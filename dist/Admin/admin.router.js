 ...
 */
adminRouter.patch('/moderation/messages/:reportId/resolve', (c) => adminController.resolveMessageReport(c));
// ─────────────────────────────────────────────────────────────────────────────
// SUBSCRIPTIONS & PLANS
// ─────────────────────────────────────────────────────────────────────────────
 ...
 * }
 */
adminRouter.patch('/subscriptions/plans/:id', requireSuperAdmin, (c) => adminController.updateSubscriptionPlan(c));
// ─────────────────────────────────────────────────────────────────────────────
 ...
 */
adminRouter.patch('/fees/config/:key', requireSuperAdmin, (c) => adminController.updateFeeConfigEntry(c));
/**
 * PATCH /api/admin/fees/viewing/:id  [super_admin]
 * Body: { "viewing_fee_kes": 150, "free_for_subscribers": true }
 */
adminRouter.patch('/fees/viewing/:id', requireSuperAdmin, (c) => adminController.updateViewingFee(c));
/**
 * PATCH /api/admin/fees/boosts/:id  [super_admin]
 * Body: { "price_kes": 1500, "duration_days": 10, "is_active": true }
 */
adminRouter.patch('/fees/boosts/:id', requireSuperAdmin, (c) => adminController.updateBoostPackage(c));
// ─────────────────────────────────────────────────────────────────────────────
// SEARCH ANALYTICS
// ─────────────────────────────────────────────────────────────────────────────
/**
 ...
 */
adminRouter.patch('/ads/:id/approve', requireSuperAdmin, (c) => adminController.approveAdCampaign(c));
