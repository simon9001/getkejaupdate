...
export class AdminController {
    ...
    async getRevenueBreakdown(c) {
        try {
            ...
            return fail(c, err, 'REVENUE_BREAKDOWN_FAILED');
        }
    }
    /**
    ...
    async getDailyRevenueSeries(c) {
        try {
            ...
            return fail(c, err, 'REVENUE_SERIES_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // USERS
    ...
    async getUserStats(c) {
        try {
            ...
            return fail(c, err, 'USER_STATS_FAILED');
        }
    }
    /**
     ...
     */
    async getUserActivityProfile(c) {
        try {
            ...
            return fail(c, err, 'USER_PROFILE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // PROPERTIES
    ...
    async getPendingListings(c) {
        try {
            ...
            return fail(c, err, 'PENDING_LISTINGS_FAILED');
        }
    }
    /**
    ...
    async approveListing(c) {
        try {
            ...
            return fail(c, err, 'LISTING_APPROVE_FAILED');
        }
    }
    /**
    ...
    async rejectListing(c) {
        try {
            ...
            return fail(c, err, 'LISTING_REJECT_FAILED');
        }
    }
    /**
     ...
     */
    async getPropertiesNeedingAttention(c) {
        try {
            const page = Number(c.req.query('page')) || 1;
            const limit = Math.min(100, Number(c.req.query('limit')) || 20);
            ...
            return fail(c, err, 'ATTENTION_PROPERTIES_FAILED');
        }
    }
    /**
    ...
    async getTopListings(c) {
        try {
            ...
            return fail(c, err, 'TOP_LISTINGS_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // BOOKINGS
    ...
    async listShortStayBookings(c) {
        try {
            ...
            return fail(c, err, 'SS_BOOKINGS_FAILED');
        }
    }
    /**
    ...
    async listLongTermBookings(c) {
        try {
            ...
            return fail(c, err, 'LT_BOOKINGS_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // MODERATION
     ...
     */
    async getPendingVerifications(c) {
        try {
            const page = Number(c.req.query('page')) || 1;
            const limit = Math.min(100, Number(c.req.query('limit')) || 20);
            ...
            return fail(c, err, 'VERIFICATIONS_FAILED');
        }
    }
    /**
    ...
    async approveVerification(c) {
        try {
            ...
            return fail(c, err, 'VERIFICATION_APPROVE_FAILED');
        }
    }
    /**
    ...
    async rejectVerification(c) {
        try {
            ...
            return fail(c, err, 'VERIFICATION_REJECT_FAILED');
        }
    }
    /**
    ...
    async getOpenDisputes(c) {
        try {
            ...
            return fail(c, err, 'DISPUTES_FAILED');
        }
    }
    /**
    ...
    async getFraudReviewQueue(c) {
        try {
            ...
            return fail(c, err, 'FRAUD_QUEUE_FAILED');
        }
    }
    /**
    ...
    async getReportedMessages(c) {
        try {
            ...
            return fail(c, err, 'REPORTED_MESSAGES_FAILED');
        }
    }
    /**
    ...
    async resolveMessageReport(c) {
        try {
            ...
            return fail(c, err, 'REPORT_RESOLVE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // SUBSCRIPTIONS & PLANS
     ...
     * }
     */
    async updateSubscriptionPlan(c) {
        try {
            const user = c.get('user');
            ...
            return fail(c, err, 'PLAN_UPDATE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // FEE CONFIGURATION
    ...
    async updateFeeConfigEntry(c) {
        try {
            ...
            return fail(c, err, 'FEE_CONFIG_UPDATE_FAILED');
        }
    }
    /**
    ...
    async updateViewingFee(c) {
        try {
            ...
            return fail(c, err, 'VIEWING_FEE_UPDATE_FAILED');
        }
    }
    /**
    ...
    async updateBoostPackage(c) {
        try {
            ...
            return fail(c, err, 'BOOST_UPDATE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // SEARCH ANALYTICS
    ...
    async getSearchAnalytics(c) {
        try {
            ...
            return fail(c, err, 'SEARCH_ANALYTICS_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // SECURITY AUDIT LOG
    ...
    async getAuditLog(c) {
        try {
            ...
            return fail(c, err, 'AUDIT_LOG_FAILED');
        }
    }
    /**
    ...
    async getAuditBreakdown(c) {
        try {
            ...
            return fail(c, err, 'AUDIT_BREAKDOWN_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // AD CAMPAIGNS
    ...
    async getAdStats(c) {
        try {
            ...
            return fail(c, err, 'AD_STATS_FAILED');
        }
    }
    /**
    ...
    async listAdCampaigns(c) {
        try {
            ...
            return fail(c, err, 'ADS_FETCH_FAILED');
        }
    }
    /**
    ...
    async approveAdCampaign(c) {
        try {
            ...
            return fail(c, err, 'CAMPAIGN_APPROVE_FAILED');
        }
    }
    /**
     * PATCH /api/admin/ads/:id/pause
     */
    async pauseAdCampaign(c) {
        try {
            const id = c.req.param('id');
            ...
            return fail(c, err, 'CAMPAIGN_PAUSE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // REVIEWS
