...
import { createPropertySchema, updatePropertySchema, nearbyPlaceInputSchema, availabilityBlockSchema, createBuildingSchema, } from '../types/property.types.js';
...
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.get('/me', authenticate, (c) => propertiesController.getMyProperties(c));
// ─────────────────────────────────────────────────────────────────────────────
// 3. Admin-only routes (specific paths before /:id wildcard)
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.get('/admin/all', authenticate, requireAdmin, (c) => propertiesController.getAllPropertiesAdmin(c));
propertiesRouter.post('/buildings', authenticate, requireAdmin, zValidator('json', createBuildingSchema), (c) => propertiesController.createBuilding(c));
// ─────────────────────────────────────────────────────────────────────────────
// 4. Create (listing roles only)
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.post('/', authenticate, requireLister, zValidator('json', createPropertySchema), (c) => propertiesController.createProperty(c));
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.patch('/:id', authenticate, zValidator('json', updatePropertySchema), (c) => propertiesController.updateProperty(c));
...
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.patch('/:id/status', authenticate, requireAdmin, zValidator('json', setStatusSchema), (c) => propertiesController.setStatus(c));
propertiesRouter.patch('/:id/featured', authenticate, requireAdmin, zValidator('json', setFeaturedSchema), (c) => propertiesController.setFeatured(c));
// ─────────────────────────────────────────────────────────────────────────────
// 8. Media — upload to Cloudinary, store URL in DB
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.post('/:id/media', authenticate, (c) => propertiesController.uploadMedia(c));
propertiesRouter.delete('/:id/media/:mediaId', authenticate, (c) => propertiesController.deleteMedia(c));
// ─────────────────────────────────────────────────────────────────────────────
// 9. Nearby places — owner or admin
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.post('/:id/nearby-places', authenticate, zValidator('json', addNearbyPlacesSchema), (c) => propertiesController.addNearbyPlaces(c));
propertiesRouter.delete('/:id/nearby-places/:placeId', authenticate, (c) => propertiesController.deleteNearbyPlace(c));
// ─────────────────────────────────────────────────────────────────────────────
// 10. Short-term rental availability calendar
// ─────────────────────────────────────────────────────────────────────────────
propertiesRouter.post('/:id/availability', authenticate, zValidator('json', addAvailabilityBlocksSchema), (c) => propertiesController.addAvailabilityBlocks(c));
propertiesRouter.get('/:id/availability', (c) => propertiesController.getAvailability(c));
propertiesRouter.delete('/:id/availability/:blockId', authenticate, (c) => propertiesController.deleteAvailabilityBlock(c));
