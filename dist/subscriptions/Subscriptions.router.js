...
import { subscribePlanSchema, cancelSubscriptionSchema, adminSetStatusSchema, unlockPropertySchema, bookViewingSchema, } from '../types/Subscription.types.js';
...
// ─────────────────────────────────────────────────────────────────────────────
subscriptionsRouter.get('/plans', (c) => subscriptionsController.getPlans(c));
subscriptionsRouter.get('/plans/:id', (c) => subscriptionsController.getPlanById(c));
// ─────────────────────────────────────────────────────────────────────────────
// 2. Self-service routes  (authenticated — any role)
//    IMPORTANT: all named paths declared before any /:id wildcard
// ─────────────────────────────────────────────────────────────────────────────
subscriptionsRouter.get('/me', authenticate, (c) => subscriptionsController.getMySubscription(c));
subscriptionsRouter.get('/me/history', authenticate, (c) => subscriptionsController.getMyHistory(c));
subscriptionsRouter.get('/my-unlocks', authenticate, (c) => subscriptionsController.getMyUnlocks(c));
/**
 ...
 */
subscriptionsRouter.get('/viewing-fee/:propertyId', authenticate, (c) => subscriptionsController.getViewingFee(c));
/**
 ...
 */
subscriptionsRouter.post('/upgrade', authenticate, zValidator('json', subscribePlanSchema), (c) => subscriptionsController.upgradePlan(c));
/**
 ...
 */
subscriptionsRouter.post('/cancel', authenticate, zValidator('json', cancelSubscriptionSchema), (c) => subscriptionsController.cancelSubscription(c));
/**
 ...
 */
subscriptionsRouter.post('/unlock', authenticate, zValidator('json', unlockPropertySchema), (c) => subscriptionsController.unlockProperty(c));
/**
 ...
 */
subscriptionsRouter.post('/book-viewing', authenticate, zValidator('json', bookViewingSchema), (c) => subscriptionsController.bookViewing(c));
// ─────────────────────────────────────────────────────────────────────────────
 ...
 */
subscriptionsRouter.get('/admin/all', authenticate, requireAdmin, (c) => subscriptionsController.getAllSubscriptions(c));
/**
 * GET /api/subscriptions/admin/revenue?from=2025-01-01&to=2025-01-31
 */
subscriptionsRouter.get('/admin/revenue', authenticate, requireAdmin, zValidator('query', revenueDateSchema), (c) => subscriptionsController.getRevenueSummary(c));
/**
 * GET /api/subscriptions/admin/user/:userId
 */
subscriptionsRouter.get('/admin/user/:userId', authenticate, requireAdmin, (c) => subscriptionsController.getUserSubscriptions(c));
/**
 * PATCH /api/subscriptions/admin/:id/status
 * Body: { "status": "active" | "cancelled" | "past_due" | "expired", "reason"?: "..." }
 */
subscriptionsRouter.patch('/admin/:id/status', authenticate, requireAdmin, zValidator('json', adminSetStatusSchema), (c) => subscriptionsController.adminSetStatus(c));
/**
 * POST /api/subscriptions/admin/:id/renew
 * Manually trigger a renewal attempt for a subscription.
 */
subscriptionsRouter.post('/admin/:id/renew', authenticate, requireAdmin, (c) => subscriptionsController.adminTriggerRenewal(c));
