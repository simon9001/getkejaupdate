...
export class StaffController {
    ...
    async getKpiSnapshot(c) {
        try {
            ...
            return fail(c, err, 'STAFF_KPI_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    ...
    async approveReview(c) {
        try {
            ...
            return fail(c, err, 'REVIEW_APPROVE_FAILED');
        }
    }
    /**
    ...
    async rejectReview(c) {
        try {
            ...
            return fail(c, err, 'REVIEW_REJECT_FAILED');
        }
    }
    /**
    ...
    async deleteMessage(c) {
        try {
            ...
            return fail(c, err, 'MESSAGE_DELETE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
     ...
     */
    async getPropertiesPendingReview(c) {
        try {
            const page = Number(c.req.query('page')) || 1;
            const limit = Math.min(100, Number(c.req.query('limit')) || 20);
            ...
            return fail(c, err, 'PENDING_PROPERTIES_FAILED');
        }
    }
    /**
    ...
    async approveProperty(c) {
        try {
            ...
            return fail(c, err, 'PROPERTY_APPROVE_FAILED');
        }
    }
    /**
    ...
    async rejectProperty(c) {
        try {
            ...
            return fail(c, err, 'PROPERTY_REJECT_FAILED');
        }
    }
    /**
    ...
    async flagProperty(c) {
        try {
            ...
            return fail(c, err, 'PROPERTY_FLAG_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    ...
    async getUsers(c) {
        try {
            ...
            return fail(c, err, 'USERS_FETCH_FAILED');
        }
    }
    /**
    ...
    async getUserById(c) {
        try {
            ...
            return fail(c, err, 'USER_FETCH_FAILED');
        }
    }
    /**
    ...
    async suspendUser(c) {
        try {
            ...
            return fail(c, err, 'USER_SUSPEND_FAILED');
        }
    }
    /**
    ...
    async unsuspendUser(c) {
        try {
            ...
            return fail(c, err, 'USER_UNSUSPEND_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    ...
    async getLongTermBookings(c) {
        try {
            ...
            return fail(c, err, 'LT_BOOKINGS_FETCH_FAILED');
        }
    }
    /**
