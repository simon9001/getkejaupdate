...
export class CaretakerController {
    ...
    async getPropertyUnits(c) {
        try {
            ...
            return fail(c, err, 'UNITS_FETCH_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // TENANT MANAGEMENT
    ...
    async getTenants(c) {
        try {
            ...
            return fail(c, err, 'TENANTS_FETCH_FAILED');
        }
    }
    /**
    ...
    async getTenantDetails(c) {
        try {
            ...
            return fail(c, err, 'TENANT_DETAILS_FETCH_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    ...
    async getRentCollections(c) {
        try {
            ...
            return fail(c, err, 'RENT_COLLECTIONS_FETCH_FAILED');
        }
    }
    /**
    ...
    async recordRentPayment(c) {
        try {
            ...
            return fail(c, err, 'RENT_RECORD_FAILED');
        }
    }
    /**
    ...
    async getRentOverview(c) {
        try {
            ...
            return fail(c, err, 'RENT_OVERVIEW_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
     ...
     */
    async getMaintenanceRequests(c) {
        try {
            const userId = c.get('user').userId;
            ...
            return fail(c, err, 'MAINTENANCE_FETCH_FAILED');
        }
    }
    /**
     ...
     */
    async createMaintenanceRequest(c) {
        try {
            const userId = c.get('user').userId;
            const body = await c.req.json();
            ...
            return fail(c, err, 'MAINTENANCE_CREATE_FAILED');
        }
    }
    /**
     ...
     */
    async updateMaintenanceStatus(c) {
        try {
            const userId = c.get('user').userId;
            ...
            return fail(c, err, 'MAINTENANCE_STATUS_UPDATE_FAILED');
        }
    }
    /**
    ...
    async completeMaintenance(c) {
        try {
            ...
            return fail(c, err, 'MAINTENANCE_COMPLETE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // COMPLAINTS & ISSUES
    ...
    async getComplaints(c) {
        try {
            ...
            return fail(c, err, 'COMPLAINTS_FETCH_FAILED');
        }
    }
    /**
    ...
    async resolveComplaint(c) {
        try {
            ...
            return fail(c, err, 'COMPLAINT_RESOLVE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // MOVE-INS & MOVE-OUTS
    ...
    async getUpcomingMoveIns(c) {
        try {
            ...
            return fail(c, err, 'MOVE_INS_FETCH_FAILED');
        }
    }
    /**
    ...
    async getUpcomingMoveOuts(c) {
        try {
            ...
            return fail(c, err, 'MOVE_OUTS_FETCH_FAILED');
        }
    }
    /**
    ...
    async confirmMoveIn(c) {
        try {
            ...
            return fail(c, err, 'MOVE_IN_CONFIRM_FAILED');
        }
    }
    /**
    ...
    async confirmMoveOut(c) {
        try {
            ...
            return fail(c, err, 'MOVE_OUT_CONFIRM_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // DAILY ACTIVITY LOG
    ...
    async getActivityLogs(c) {
        try {
            ...
            return fail(c, err, 'ACTIVITY_LOGS_FETCH_FAILED');
        }
    }
    /**
    ...
    async createActivityLog(c) {
        try {
            ...
            return fail(c, err, 'ACTIVITY_LOG_CREATE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // INVENTORY & ASSETS
    ...
    async getInventory(c) {
        try {
            ...
            return fail(c, err, 'INVENTORY_FETCH_FAILED');
        }
    }
    /**
    ...
    async addInventoryItem(c) {
        try {
            ...
            return fail(c, err, 'INVENTORY_ADD_FAILED');
        }
    }
    /**
    ...
    async updateInventoryItem(c) {
        try {
            ...
            return fail(c, err, 'INVENTORY_UPDATE_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // VISITOR MANAGEMENT
    ...
    async getVisitorLogs(c) {
        try {
            ...
            return fail(c, err, 'VISITOR_LOGS_FETCH_FAILED');
        }
    }
    /**
    ...
    async logVisitor(c) {
        try {
            ...
            return fail(c, err, 'VISITOR_LOG_FAILED');
        }
    }
    /**
    ...
    async visitorCheckout(c) {
        try {
            ...
            return fail(c, err, 'VISITOR_CHECKOUT_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // UTILITY READINGS
    ...
    async getUtilityReadings(c) {
        try {
            ...
            return fail(c, err, 'UTILITY_READINGS_FETCH_FAILED');
        }
    }
    /**
    ...
    async submitUtilityReading(c) {
        try {
            ...
            return fail(c, err, 'UTILITY_READING_SUBMIT_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // NOTIFICATIONS
    ...
    async getNotifications(c) {
        try {
            ...
            return fail(c, err, 'NOTIFICATIONS_FETCH_FAILED');
        }
    }
    /**
    ...
    async markNotificationRead(c) {
        try {
            ...
            return fail(c, err, 'NOTIFICATION_READ_FAILED');
        }
    }
    // ─────────────────────────────────────────────────────────────────────────
    // PROFILE
